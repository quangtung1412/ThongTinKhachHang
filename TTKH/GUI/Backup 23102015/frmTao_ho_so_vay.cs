    ...
    public partial class frmTao_ho_so_vay : Form
    {
        ...
        internal void Cap_nhat_txtMa_hd_vay()
        {
            ...
            if (khv.loai_kh == "Tổ chức")
            {
                ...
                {
                    cboxLoai_hop_dong_tin_dung.Items.Add("Hợp đồng cấp tín dụng từng lần cho doanh nghiệp - TUNG_LAN_TC");
                }
                else if (hd.phuong_thuc == "Hạn mức tín dụng không bảo lãnh")
                {
                    cboxLoai_hop_dong_tin_dung.Items.Add("Hợp đồng cấp tín dụng hạn mức cho doanh nghiệp (không bảo lãnh) - HMTD_KBL_TC");
                }
                else if (hd.phuong_thuc == "Hạn mức tín dụng có bảo lãnh")
                {
                    cboxLoai_hop_dong_tin_dung.Items.Add("Hợp đồng cấp tín dụng hạn mức cho doanh nghiệp (có bảo lãnh) - HMTD_CBL_TC");
                }
            }
            else if (khv.loai_kh == "Hộ gia đình")
            {
                if (hd.phuong_thuc == "Từng lần")
                {
                    ...
                    {
                        cboxLoai_hop_dong_tin_dung.Items.Add("Hợp đồng cấp tín dụng từng lần cho hộ gia đình - TUNG_LAN_CHC");
                    }
                    else if (khv.hgd_dai_dien == "Vợ")
                    {
                        cboxLoai_hop_dong_tin_dung.Items.Add("Hợp đồng cấp tín dụng từng lần cho hộ gia đình - TUNG_LAN_CHV");
                    }
                }
                else if (hd.phuong_thuc == "Hạn mức tín dụng không bảo lãnh")
                {
                    if (khv.hgd_dai_dien == "Chồng")
                    {
                        cboxLoai_hop_dong_tin_dung.Items.Add("Hợp đồng cấp tín dụng hạn mức cho hộ gia đình (không bảo lãnh) - HMTD_KBL_CHC");
                    }
                    else if (khv.hgd_dai_dien == "Vợ")
                    {
                        cboxLoai_hop_dong_tin_dung.Items.Add("Hợp đồng cấp tín dụng hạn mức cho hộ gia đình (không bảo lãnh) - HMTD_KBL_CHV");
                    }
                }
                else if (hd.phuong_thuc == "Hạn mức tín dụng có bảo lãnh")
                {
                    if (khv.hgd_dai_dien == "Chồng")
                    {
                        cboxLoai_hop_dong_tin_dung.Items.Add("Hợp đồng cấp tín dụng hạn mức cho hộ gia đình (có bảo lãnh) - HMTD_CBL_CHC");
                    }
                    else if (khv.hgd_dai_dien == "Vợ")
                    {
                        cboxLoai_hop_dong_tin_dung.Items.Add("Hợp đồng cấp tín dụng hạn mức cho hộ gia đình (có bảo lãnh) - HMTD_CBL_CHV");
                    }
                }                             
            }
            else if (khv.loai_kh == "Cá nhân")
            {
                if (hd.phuong_thuc == "Từng lần")
                {
                    cboxLoai_hop_dong_tin_dung.Items.Add("Hợp đồng cấp tín dụng từng lần cho cá nhân - TUNG_LAN_CN");
                }
                else if (hd.phuong_thuc == "Hạn mức tín dụng không bảo lãnh")
                {
                    cboxLoai_hop_dong_tin_dung.Items.Add("Hợp đồng cấp tín dụng hạn mức cho cá nhân (không bảo lãnh) - HMTD_KBL_CN");
                }
                else if (hd.phuong_thuc == "Hạn mức tín dụng có bảo lãnh")
                {
                    cboxLoai_hop_dong_tin_dung.Items.Add("Hợp đồng cấp tín dụng hạn mức cho cá nhân (có bảo lãnh) - HMTD_CBL_CN");
                }
            }
        ...
        internal void Lay_thong_tin_ho_so_vay()
        {
            ...
            this.dich_thong_tin_chung.Add(CommonMethods.TachMaHopDong(hd.ma_hd_vay));
...
//-------------------------------------TẠO HỢP ĐỒNG TÍN DỤNG --------------------------------------------------------------
        ...
        private void btnTao_hop_dong_tin_dung_Click(object sender, EventArgs e)
        {
            ...
            if (string.IsNullOrEmpty(txtNgay_hop_dong_tin_dung.Text))
            {
            ...
            switch (cboxLoai_hop_dong_tin_dung.Text)
            {
