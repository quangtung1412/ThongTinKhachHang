...
namespace AGRIBANKHD.GUI
{
    public partial class frmNhap_thong_tin_kh_vay : Form
    {
        ...
        public frmNhap_thong_tin_kh_vay(string ma_cn, string ten_cn, string ma_kh_vay)
        {
            ...
            txtCn_ten_viet_tat.Text = kh.cn_ten_viet_tat;
            txtTc_ten_viet_tat.Text = kh.tc_ten_viet_tat;
            txtHgd_ten_viet_tat.Text = kh.hgd_ten_viet_tat;
        }
        ...
        private void cboxLoai_kh_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cboxLoai_kh.Text=="Cá nhân")
            {
                ...
                txtCn_ten_viet_tat.Text = "Bên vay";
                //txtCn_ten_viet_tat.ReadOnly = true;
                txtTc_ten_viet_tat.Clear();
                txtHgd_ten_viet_tat.Clear();
            }
            else if (cboxLoai_kh.Text=="Hộ gia đình")
            {
                ...
                txtCn_ten_viet_tat.Clear();
                txtTc_ten_viet_tat.Clear();
                txtHgd_ten_viet_tat.Text = "Bên vay";
                //txtHgd_ten_viet_tat.ReadOnly = true;
            }
        ...
        private void btnCap_nhat_Click(object sender, EventArgs e)
        {
            ...
            //Start - Thêm mới khách hàng
            {
                ...
                string[] thong_tin_kh = new string[65];
                ...
                thong_tin_kh[62] = txtHgd_ten_viet_tat.Text;
                thong_tin_kh[63] = txtCn_ten_viet_tat.Text;
                thong_tin_kh[64] = txtTc_ten_viet_tat.Text;
                Khachhangvay kh = new Khachhangvay(thong_tin_kh);
                if (kh_vaybus.THEM_KH_VAY(kh))
                {
                    DialogResult dialogResult = MessageBox.Show("Nhập thông tin khách hàng thành công! Bạn có muốn tiếp tục nhập thông tin hợp đồng vay cho khách hàng này?", "Nhập thông tin khách hàng thành công", MessageBoxButtons.YesNo);
                    if (dialogResult == DialogResult.Yes)
                    {
                        this.Close();
                        frmNhap_thong_tin_hop_dong_vay frm = new frmNhap_thong_tin_hop_dong_vay(txtma_CN.Text, cboxChi_nhanh.Text);
                        frm._ma_kh_vay = txtMa_kh_vay.Text;
                        frm.Cap_nhat_txtMa_kh_vay();
