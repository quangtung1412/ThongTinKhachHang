...
namespace AGRIBANKHD.GUI
{
    public partial class frmTai_san_the_chap : Form
    {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            //    //string ma_ts_the_chap = Convert.ToString(selectedRow.Cells["ma_ts_the_chap"].Value);
            //    int ma_ts_the_chap = Convert.ToInt32(selectedRow.Cells["MA_TS_THE_CHAP"].Value);
            //    frmNhap_tai_san_the_chap frm = new frmNhap_tai_san_the_chap(ma_ts_the_chap);
            //    //frm.Sua_tai_san_the_chap(ma_ts_the_chap);
            //    frm.MdiParent = this.MdiParent;
            //    frm.Show();
            //    frm.BringToFront();
            ...
            //else
            //{
            //    MessageBox.Show("Chưa có tài sản thế chấp nào được chọn để cập nhật thông tin");
            //}
        }
        ...
        //    //if (dgvDanh_sach_tstc.SelectedCells.Count > 0) 
        //    //{
        //    //    if (MessageBox.Show("Bạn có chắc muốn xóa tài sản thế chấp này?", "Xác nhận", MessageBoxButtons.YesNo) == DialogResult.Yes)
        //    //    {
        //    //        int selectedrowindex = dgvDanh_sach_tstc.SelectedCells[0].RowIndex;
        //    //        DataGridViewRow selectedRow = dgvDanh_sach_tstc.Rows[selectedrowindex];
        //    //        string ma_ts_the_chap = Convert.ToString(selectedRow.Cells["ma_ts_the_chap"].Value);
        //    //        if (tstcbus.Xoa_TSTC(ma_ts_the_chap))
        //    //        {
        //    //            MessageBox.Show("Xóa thông tin tài sản thế chấp thành công!");
        ...
        //    //else
        //    //{
        //    //    MessageBox.Show("Chưa có tài sản thế chấp nào được chọn để xóa thông tin");
        //    //}
        //}
