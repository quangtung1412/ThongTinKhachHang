...
namespace AGRIBANKHD.GUI
{
    public partial class frmNhap_thong_tin_hop_dong_vay : Form
    {
        ...
        public frmNhap_thong_tin_hop_dong_vay(string ma_cn, string ten_cn,string ma_hd_vay)
        {
            ...
            DataTable kiemsoattindung = AGRIBANKHD.BUS.CanbotindungBUS.tbl_CBTD_CV(txtma_CN.Text, "Trưởng phòng tín dụng");
            DataTable kiemsoattindung_temp1 = AGRIBANKHD.BUS.CanbotindungBUS.tbl_CBTD_CV(txtma_CN.Text, "Phó phòng tín dụng");
            ...
            DataTable kiemsoattindung_temp3 = AGRIBANKHD.BUS.CanbotindungBUS.tbl_CBTD_CV(txtma_CN.Text, "Phó Giám đốc phòng giao dịch");
            ...
            DataTable dscanbotindung = AGRIBANKHD.BUS.CanbotindungBUS.tbl_CBTD_CV(txtma_CN.Text, "Phó phòng tín dụng");
            DataTable dscanbotindung_temp1 = AGRIBANKHD.BUS.CanbotindungBUS.tbl_CBTD_CV(txtma_CN.Text, "Phó Giám đốc phòng giao dịch");
            dscanbotindung.Merge(dscanbotindung_temp1);
            DataTable dscanbotindung_temp2 = AGRIBANKHD.BUS.CanbotindungBUS.tbl_CBTD_CV(txtma_CN.Text, "Cán bộ tín dụng");
            ...
            if (!Thong_tin_dang_nhap.admin && !(Thong_tin_dang_nhap.chuc_vu == "Trưởng phòng tín dụng"))
            {
        ...
        internal void THEM_HD_VAY()
        {
            ...
            if (hdbus.Kiem_tra_trung_ma_hd(CommonMethods.NhapMaHopDong(txtMa_hd_vay.Text)))
            {
            ...
            //    return;
            //}        
            string[] hop_dong_vay = new string[24];
            ...
            {
                MessageBox.Show("Nhập thông tin hợp đồng thành công!");
                this.Close();
            }
            else
            {
